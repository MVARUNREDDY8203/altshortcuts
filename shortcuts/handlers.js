const handlers = {
    ...
    "x.com": {
        search: () =>
            ...
            document.querySelector("a[aria-label = 'Search and explore']"),
        write: () => document.querySelector("a[aria-label = 'Post']"),
    },
    "www.reddit.com": {
        search: () =>
            document
    ...
    "mail.google.com": {
        search: () => document.querySelector("input[aria-label='Search mail']"),
        write: () =>
            document.querySelector(
    ...
    "chatgpt.com": {
        search: () => document.querySelector("button[aria-label = 'Ctrl K"), // No search bar
        write: () => document.querySelector("#prompt-textarea"),
    },
    "www.linkedin.com": {
        search: () => document.querySelector("input[aria-label='Search']"),
        write: () => document.querySelector("#ember34"),
    },
    "www.facebook.com": {
        search: () =>
            document.querySelector("input[aria-label='Search on Facebook']"),
        write: () =>
            document.querySelector(
    ...
    "www.instagram.com": {
        search: () =>
            Array.from(document.querySelectorAll("svg title"))
                .find((title) => title.textContent.trim() === "Search")
                .closest("a"),
        write: () =>
            Array.from(document.querySelectorAll("svg title"))
                .find((title) => title.textContent.trim() === "New post")
                .closest("a"),
    },
    "web.whatsapp.com": {
        search: () => document.querySelector("div[aria-label = 'Search']"),
        write: () =>
            document.querySelector("div[aria-label = 'Type a message']"),
    },
    "web.snapchat.com": {
        search: () => document.querySelector("input[role='searchbox']"),
        write: () => document.querySelector("div[role='textbox']"),
    },
    "github.com": {
        search: () =>
            document.querySelector("button[aria-label='Search or jump to…']"),
        write: () =>
            document.querySelector("button[aria-label='Create something new']"),
    },
    "stackoverflow.com": {
        search: () => document.querySelector("input[aria-label='Search']"),
        write: () => document.querySelector("a[href='/questions/ask']"),
    },
    "peerlist.io": {
        search: () =>
            document.querySelector("input#react-select-peerlist-search-input"),
        write: () =>
            document.querySelector(
    ...
    "www.imdb.com": {
        search: () => document.querySelector("input[aria-label='Search IMDb']"),
    },
    "www.primevideo.com": {
        search: () =>
            document.querySelector("button[aria-label='Search Prime Video']"),
    },
    "www.coursera.org": {
        search: () => document.querySelector("input"),
    },
    ...
    "en.wikipedia.org": {
        search: () =>
            document.querySelector("a[href = '/wiki/Special:Search']") ||
